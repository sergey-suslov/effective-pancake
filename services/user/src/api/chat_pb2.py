...
_CHAT.fields_by_name['userOne'].message_type = src_dot_api_dot_common__pb2._USERPROFILE
_CHAT.fields_by_name['userTwo'].message_type = src_dot_api_dot_common__pb2._USERPROFILE
